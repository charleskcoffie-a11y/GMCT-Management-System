...
export const DEFAULT_SHAREPOINT_HALL_LIST_NAME = "Hall_Rental";
...
export const SHAREPOINT_HALL_LIST_NAME = DEFAULT_SHAREPOINT_HALL_LIST_NAME;
export const SHAREPOINT_HISTORY_LIST_NAME = DEFAULT_SHAREPOINT_HISTORY_LIST_NAME;
