                    ...
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        {hasChanges ? (
                            <button
                                type="button"
                                onClick={handleSave}
                                className="px-6 py-2 rounded-lg shadow-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700"
                            >
                                Save Attendance
                            </button>
                        ) : (
                            <span className="text-xs text-slate-500">Search and select members above to enable saving.</span>
                        )}
                    </div>
                </section>
            ) : (
