...
import keyboardIcon from '../assets/login-icon.svg';
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 flex items-center justify-center px-4 py-10">
            <div className="w-full max-w-md rounded-3xl shadow-2xl border border-white/20 bg-white/90 backdrop-blur p-8">
                <div className="flex items-start gap-4 mb-6">
                    <span className="inline-flex h-16 w-16 flex-none items-center justify-center rounded-2xl bg-indigo-50 border border-indigo-100 text-indigo-600 shadow-sm">
                        <img
                            src={keyboardIcon}
                            alt="Keyboard icon"
                            className="h-10 w-10"
